...
public class xpath extends testbase {
	//login page
		public  String login_Email="//android.widget.ScrollView/android.widget.ImageView[2]";
		public  String login_password ="//android.widget.EditText";
		public String login_button= "//android.widget.Button[@content-desc=\"LOGIN\"]";
		public String blank_message="//android.view.View[@content-desc=\"Please enter a valid email Address\"]";
		public String Bad_credentials= "//android.view.View[@content-desc=\"Bad credentials!\"]";
		public String Login_Successful= "//android.view.View[@content-desc=\"Login Successful\"]";
